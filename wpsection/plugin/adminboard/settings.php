...
<form action="<?php echo esc_url( menu_page_url( 'admin.php?page=wpsection-settings' ) ); ?>" class="page-wrapper wp_sectionform" method="post" enctype="multipart/form-data">
    <?php settings_errors( 'wpsection_success' ); ?>
    <div class="wps_level">
        <label for="show_shop">Hide Shop:</label>
